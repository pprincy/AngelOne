...
(function(factory) {
    ...
    $.fn.dateRangePicker = function(opt) {
        ...
        function generateSelect(name, data) {
            var select = '<div class="select-wrapper '+ name+'"><select class="' + name + '" name="' + name + '">';
            var current;
        ...
        function createDom() {
            ...
            html += '<div class="month-wrapper">' +
                ...
                '       <thead>' +
                ' <tr class="label"><th colspan="100%">Start Date</th> </tr>' +
                '           <tr class="caption">' +
            ...
            if (hasMonth2()) {
                html += '<div class="gap">' + getGapHTML() + '</div>' +
                    ...
                    '   <thead>' +
                    ' <tr class="label"><th colspan="100%">End Date</th> </tr>' +
                    '   <tr class="caption">' +
                    '       <th colspan="' + _colspan + '" class="month-name">' +
                    '       </th>' +
                    '       <th class="th-prev">' +
